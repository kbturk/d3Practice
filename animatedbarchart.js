...
function brandGraph(data) {
    ...
    function rank(value) {
        const data2 = Array.from(names, name => ({ name, value: value(name) }));
    ...
    function bars(svg) {
        ...
        return ([date, data], transition) => bar = bar
            ...
            .attr("width", d => x((prev.get(d) || d).value) - x(0)), update => update, exit => exit.transition(transition).remove()
    ...
    function labels(svg) {
        ...
        return ([date, data], transition) => label = label
            ...
            .attr("x", -6)
            .attr("dy", "1.15em")), update => update, exit => exit.transition(transition).remove()
...
//# sourceMappingURL=animatedbarchart.js.map